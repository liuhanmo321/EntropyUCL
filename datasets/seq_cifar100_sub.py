...
# Pickling
class SequentialCIFAR100Sub(ContinualDataset):
    ...
    def get_data_loaders(self, args):
        ...
        with open("data/CIFAR100/cifar-100-python/meta","rb") as file_handle:
            retrieved_data = pickle.load(file_handle)
        
        # selected_classes = [['apple', 'orange'], ['flatfish', 'shark'], ['bottle', 'bowl'], ['bed', 'chair'], ['bear', 'lion'], ['forest', 'sea'], ['clock', 'television'], ['orchid', 'rose'], ['camel', 'elephant'], ['bus', 'train']]
        # selected_classes = [['apple', 'orange', 'pear', 'sweet_pepper'], ['flatfish', 'shark', 'ray', 'trout'], ['bottle', 'bowl', 'can', 'plate'], ['bed', 'chair', 'couch', 'table'], ['bear', 'lion', 'tiger', 'wolf']]
