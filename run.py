...
def main(device, args):
    ...
    # result_recording_path = result_path + '/' + args.model.cl_model + scl_prefix + args.model.name + '.txt'
    # result_plot_path = result_path + '/' + args.model.cl_model + scl_prefix + '.png'
    # result_plot_tot_path = result_path + '/' + args.model.cl_model + scl_prefix + '_tot.png'
    ...
    if args.model.cl_model != 'joint':
        for t in range(dataset.N_TASKS):
            ...
            if 'dis' in args.model.cl_model and t > 0:
        ...
        model_path = os.path.join(args.ckpt_dir, f"{args.model.cl_model}{scl_prefix}_{args.dataset.name}_{args.model.name}{args.utils.comment}_{0}.pth")
        torch.save({
            'epoch': epoch+1,
            'state_dict':model.net.state_dict()
        }, model_path)
